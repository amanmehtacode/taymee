...
(() => {
    ...
    var u = (e, t) => () => (t || e((t = {
        ...
        xs = (e, t, r, n) => {
            if (t && typeof t == "object" || typeof t == "function")
                for (let i of H_(t)) !X_.call(e, i) && i !== r && tn(e, i, {
                    get: () => t[i],
                    enumerable: !(n = V_(t, i)) || n.enumerable
                });
            return e
        };
    var ue = (e, t, r) => (r = e != null ? U_(W_(e)) : {}, xs(t || !e || !e.__esModule ? tn(r, "default", {
            value: e,
            enumerable: !0
        }) : r, e)),
    ...
    var xi = u(() => {
        ...
        window.tram = function (e) {
            ...
            function c(l, E, T) {
                ...
                var I = T;
                return xt.test(l) || !ct.test(l) ? I = parseInt(l, 10) : ct.test(l) && (I = 1e3 * parseFloat(l)), 0 > I && (I = 0), I === I ? I : T
            }
            ...
            var d = function (l, E, T) {
                    ...
                    function K(re, pe) {
                        ...
                        var ae, _e = O[l] = re[l],
                            Ze = ne[l] = G[l] = new O;
                        return Ze.constructor = G, G.mixin = function (Re) {
                            return ne[l] = G[l] = K(G, Re)[l], G
                        }, G.open = function (Re) {
                            if (ae = {}, m(Re) ? ae = Re.call(G, Ze, _e, G, re) : I(Re) && (ae = Re), I(ae))
                ...
                g = {
                    ...
                    "ease-in-back": ["cubic-bezier(0.600, -0.280, 0.735, 0.045)", function (l, E, T, I, m) {
                        return m === void 0 && (m = 1.70158), T * (l /= I) * l * ((m + 1) * l - m) + E
                    }],
                    "ease-out-back": ["cubic-bezier(0.175, 0.885, 0.320, 1.275)", function (l, E, T, I, m) {
                        return m === void 0 && (m = 1.70158), T * ((l = l / I - 1) * l * ((m + 1) * l + m) + 1) + E
                    }],
                    "ease-in-out-back": ["cubic-bezier(0.680, -0.550, 0.265, 1.550)", function (l, E, T, I, m) {
                        return m === void 0 && (m = 1.70158), (l /= I / 2) < 1 ? T / 2 * l * l * (((m *= 1.525) + 1) * l - m) + E : T / 2 * ((l -= 2) * l * (((m *= 1.525) + 1) * l + m) + 2) + E
                    }]
                },
                h = {
                ...
                B = function (l) {
                    ...
                    var E, T, I = "",
                        m = l.split("-");
                    for (E = 0; E < m.length; E++) I += m[E].charAt(0).toUpperCase() + m[E].slice(1);
                    for (E = 0; E < b.length; E++)
                        if (T = b[E] + I, T in q.style) return {
                            dom: T,
                            css: L[E] + l
                        }
                },
            ...
            var P = t.frame = function () {
                ...
                j = d(function (l) {
                    function E(Q, se) {
                        ...
                        if (!se.weak || !this.props[le]) {
                            var We = Ce[0],
                                qe = this.props[le];
                            return qe || (qe = this.props[le] = new We.Bare), qe.init(this.$el, ye, Ce, se), qe
                        }
                    }
                    ...
                    function T(Q, se, ye) {
                        if (Q) {
                            ...
                            if (le == "object") {
                                ...
                                }), _e.call(this), Ce > 0 && (this.timer = new de({
                                    duration: Ce,
                                    context: this
                    ...
                    function K(Q) {
                        ...
                        var se;
                        typeof Q == "string" ? (se = {}, se[Q] = 1) : se = typeof Q == "object" && Q != null ? Q : this.props, Ze.call(this, se, Re), _e.call(this)
                    }
                    ...
                    function _e() {
                        ...
                        ye = ye.join(","), this.style !== ye && (this.style = ye, this.el.style[U.transition.dom] = ye)
                    }

                    function Ze(Q, se, ye) {
                        var le, Ce, We, qe, en = se !== Re,
                            Te = {};
                        for (le in Q) We = Q[le], le in ve ? (Te.transform || (Te.transform = {}), Te.transform[le] = We) : (S.test(le) && (le = r(le)), le in H ? Te[le] = We : (qe || (qe = {}), qe[le] = We));
                        for (le in Te) {
                    ...
                    function He(Q, se) {
                        l[Q] = function () {
                            return this.children ? F_.call(this, se, arguments) : (this.el && se.apply(this, arguments), this)
                        }
                    }
                    ...
                    }, He("add", E), He("start", T), He("wait", I), He("then", m), He("next", O), He("stop", K), He("set", re), He("show", pe), He("hide", G), He("redraw", ne), He("destroy", ae)
                }),
                D = d(j, function (l) {
                    function E(T, I) {
                ...
                M = d(function (l) {
                    ...
                    l.init = function (O, K, re, pe) {
                        ...
                        var G = K[0];
                        re[2] && (G = re[2]), z[G] && (G = z[G]), this.name = G, this.type = re[1], this.duration = c(K[1], this.duration, m.duration), this.ease = T(K[2], this.ease, m.ease), this.delay = c(K[3], this.delay, m.delay), this.span = this.duration + this.delay, this.active = !1, this.nextStyle = null, this.auto = Y.test(this.name), this.unit = pe.unit || this.unit || ce.defaultUnit, this.angle = pe.angle || this.angle || ce.defaultAngle, ce.fallback || pe.fallback ? this.animate = this.fallback : (this.animate = this.transition, this.string = this.name + te + this.duration + "ms" + (this.ease != "ease" ? te + g[this.ease][0] : "") + (this.delay ? te + this.delay + "ms" : ""))
                    }, l.set = function (O) {
                        ...
                        O = this.convert(O, this.type), this.auto && (K == "auto" && (K = this.convert(this.get(), this.type)), O == "auto" && (O = E.call(this))), this.tween = new Z({
                            from: K,
                            to: O,
                ...
                oe = d(M, function (l, E) {
                    function T(I, m) {
                        var O, K, re, pe, G;
                        for (O in I) pe = ve[O], re = pe[0], K = pe[1] || O, G = this.convert(I[O], re), m.call(this, K, G, re)
                    }
                    l.init = function () {
                        E.init.apply(this, arguments), this.current || (this.current = {}, ve.perspective && ce.perspective && (this.current.perspective = ce.perspective, v(this.el, this.name, this.style(this.current)), this.redraw()))
                    }, l.set = function (I) {
                        ...
                        return T.call(this, I, function (K, re, pe) {
                            O[K] = re, this.current[K] === void 0 && (m = 0, ~K.indexOf("scale") && (m = 1), this.current[K] = this.convert(m, pe))
                        }), O
                    }
                }),
                Z = d(function (l) {
                    ...
                    function T() {
                        ...
                        if (_e)
                            for (P(T), ne = W(), G = _e; G--;) ae = re[G], ae && ae.render(ne)
                    }
                    ...
                    l.init = function (G) {
                        ...
                        g[ne] && (ne = g[ne][1]), typeof ne != "function" && (ne = K.ease), this.ease = ne, this.update = G.update || o, this.complete = G.complete || o, this.context = G.context || this, this.name = G.name;
                        var ae = G.from,
                            _e = G.to;
                        ae === void 0 && (ae = K.from), _e === void 0 && (_e = K.to), this.unit = G.unit || "", typeof ae == "number" && typeof _e == "number" ? (this.begin = ae, this.change = _e - ae) : this.format(_e, ae), this.value = this.begin + this.unit, this.start = W(), G.autoplay !== !1 && this.play()
                    }, l.play = function () {
                        this.active || (this.start || (this.start = W()), this.active = !0, E(this))
                    }, l.stop = function () {
                        ...
                        if (ae < this.duration) {
                            ...
                            return ne = this.startRGB ? O(this.startRGB, this.endRGB, _e) : m(this.begin + _e * this.change), this.value = ne + this.unit, void this.update.call(this.context, this.value)
                        }
                        ...
                        if (ne += "", G += "", G.charAt(0) == "#") return this.startRGB = n(ne), this.endRGB = n(G), this.endHex = G, this.begin = 0, void(this.change = 1);
                        if (!this.unit) {
                            var ae = ne.replace(x, ""),
                                _e = G.replace(x, "");
                ...
                ut = d(Z, function (l, E) {
                    l.init = function (T) {
                        ...
                        var I, m;
                        for (I in T.values) m = T.values[I], this.current[I] !== m && this.tweens.push(new Z({
                            name: I,
                            from: this.current[I],
                            to: m,
                            duration: T.duration,
                        ...
                        var I, m, O = this.tweens.length,
                            K = !1;
                        for (I = O; I--;) m = this.tweens[I], m.context && (m.render(T), this.current[m.name] = m.value, K = !0);
            ...
            U.transform && (H.transform = [oe], ve = {
                ...
                skewX: [V],
                skewY: [V]
            }), U.transform && U.backface && (ve.z = [w, "translateZ"], ve.rotateZ = [V], ve.scaleZ = [A], ve.perspective = [C]);
            var xt = /ms/,
                ct = /s|\./;
            return e.tram = t
        }(window.jQuery)
    ...
    var ws = u((wH, Ss) => {
        ...
        Ss.exports = function () {
            ...
            e.contains = e.include = function (b, L) {
                ...
                var L, B, U;
                return function () {
                    L || (L = !0, B = arguments, U = this, k_.frame(function () {
                        L = !1, b.apply(U, B)
                    }))
                }
                ...
                var U, J, ee, P, W, j = function () {
                    var D = e.now() - P;
                    D < L ? U = setTimeout(j, L - D) : (U = null, B || (W = b.apply(ee, J), ee = J = null))
                };
                return function () {
                    ee = this, J = arguments, P = e.now();
                    var D = B && !U;
                    return U || (U = setTimeout(j, L)), D && (W = b.apply(ee, J), ee = J = null), W
                }
            ...
            return e.template = function (b, L, B) {
                ...
                b.replace(U, function (D, M, $, ie, oe) {
                    return ee += b.slice(J, oe).replace(Y, te), J = oe + D.length, M ? ee += `'+
    ...
    var ke = u((RH, Ds) => {
        ...
        function Ns(e) {
            fe.env() && (et(e.design) && Be.on("__wf_design", e.design), et(e.preview) && Be.on("__wf_preview", e.preview)), et(e.destroy) && Be.on("__wf_destroy", e.destroy), e.ready && et(e.ready) && z_(e)
        }
        ...
        function Ls(e) {
            et(e.design) && Be.off("__wf_design", e.design), et(e.preview) && Be.off("__wf_preview", e.preview), et(e.destroy) && Be.off("__wf_destroy", e.destroy), e.ready && et(e.ready) && K_(e)
        }
        ...
        fe.destroy = function (e) {
            e = e || {}, Ri = !0, Be.triggerHandler("__wf_destroy"), e.domready != null && (nn = e.domready), Xe.each(Gt, Ls), fe.resize.off(), fe.scroll.off(), fe.redraw.off(), Ut = [], wi = [], St.state() === "pending" && Ms()
        };
        Et(fe.ready);
        Ms();
    ...
    var Hs = u((NH, Vs) => {
        ...
        Ni.define("edit", Vs.exports = function (e, t, r) {
            if (r = r || {}, (Ni.env("test") || Ni.env("frame")) && !r.fixture && !J_()) return {
                exit: 1
            };
            var n = {},
                i = e(window),
            ...
            function h(R) {
                return function (C) {
                    ...
                    C.thirdPartyCookiesSupported = R, y(N(C.bugReporterScriptPath), function () {
            ...
            function S(R) {
                ...
                var w = function (V) {
                    V.data === "WF_third_party_cookies_unsupported" ? (A(C, w), R(!1)) : V.data === "WF_third_party_cookies_supported" && (A(C, w), R(!0))
                };
                C.onerror = function () {
                    A(C, w), R(!1)
                }, window.addEventListener("message", w, !1), window.document.body.appendChild(C)
            }
    ...
    var Xs = u((LH, Ws) => {
        ...
        eT.define("focus-visible", Ws.exports = function () {
            function e(r) {
                ...
                document.addEventListener("keydown", d, !0), document.addEventListener("mousedown", g, !0), document.addEventListener("pointerdown", g, !0), document.addEventListener("touchstart", g, !0), document.addEventListener("visibilitychange", _, !0), N(), r.addEventListener("focus", h, !0), r.addEventListener("blur", y, !0)
            }
    ...
    var Js = u((DH, lt) => {
        function Mi(e) {
            ...
            }, lt.exports.__esModule = !0, lt.exports.default = lt.exports, Mi(e)
        }
    ...
    var un = u((FH, Er) => {
        ...
        function iT(e, t) {
            ...
            if (e === null || nT(e) !== "object" && typeof e != "function") return {
                default: e
            };
            var r = eu(t);
        ...
        Er.exports = iT, Er.exports.__esModule = !0, Er.exports.default = Er.exports
    });
    var tu = u((GH, yr) => {
        function oT(e) {
        ...
        yr.exports = oT, yr.exports.__esModule = !0, yr.exports.default = yr.exports
    });
    var Ee = u((UH, ru) => {
        var cn = function (e) {
    ...
    var Pu = u((tW, Lu) => {
        var Nu = Ee(),
            ...
            Cu = Ru && Ru.v8,
            ze, fn;
        Cu && (ze = Cu.split("."), fn = ze[0] > 0 && ze[0] < 4 ? 1 : +(ze[0] + ze[1]));
    ...
    var dc = u((EW, fc) => {
        ...
        fc.exports = function (e, t) {
            ...
            var r = cb(e, pb),
                n;
            if (r) {
                if (t === void 0 && (t = "default"), n = ub(r, e, t), !cc(n) || lc(n)) return n;
    ...
    var Fc = u((RW, Dc) => {
        var Kb = wc(),
            ...
            lo = Mc.TypeError,
            Jb = Mc.WeakMap,
            hn, Or, En, eI = function (e) {
                return En(e) ? Or(e) : hn(e, {})
            },
            tI = function (e) {
                return function (t) {
                    var r;
                    if (!Yb(t) || (r = Or(t)).type !== e) throw lo("Incompatible receiver, " + e + " required");
                    return r
                }
            };
        Kb || uo.state ? (mt = uo.state || (uo.state = new Jb), Pc = ao(mt.get), co = ao(mt.has), qc = ao(mt.set), hn = function (e, t) {
            ...
            return co(mt, e)
        }) : (Ct = Qb("state"), Zb[Ct] = !0, hn = function (e, t) {
    ...
    var kc = u((NW, Bc) => {
        ...
        (Bc.exports = function (e, t, r, n) {
            var i = n ? !!n.unsafe : !1,
                ...
                c;
            if (Hc(r) && (String(s).slice(0, 7) === "Symbol(" && (s = "[" + String(s).replace(/^Symbol\(([^)]*)\)/, "$1") + "]"), (!sI(r, "name") || lI && r.name !== s) && Wc(r, "name", s), c = dI(r), c.source || (c.source = pI.join(typeof s == "string" ? s : ""))), e === aI) {
                o ? e[t] = r : uI(t, r);
                return
    ...
    var gl = u((BW, vl) => {
        ...
        vl.exports = function (e, t) {
            var r = e.target,
                ...
                i = e.stat,
                o, a, s, c, f, p;
            if (n ? a = yo : i ? a = yo[r] || ZI(r, {}) : a = (yo[r] || {}).prototype, a)
                for (s in t) {
                    if (f = t[s], e.noTargetGet ? (p = YI(a, s), c = p && p.value) : c = a[s], o = eO(n ? s : r + (i ? "." : "#") + s, e.forced), !o && c !== void 0) {
    ...
    var ml = u((jW, yl) => {
        ...
        yl.exports = nO ? Object.defineProperties : function (t, r) {
            oO(t);
            for (var n = aO(r), i = sO(r), o = i.length, a = 0, s; o > a;) iO.f(t, s = i[a++], n[s]);
            return t
        }
    });
    var Tl = u((zW, _l) => {
    ...
    var Rl = u((KW, wl) => {
        var cO = br(),
            ...
            gO = function () {
                var e = pO("iframe"),
                    t = "java" + To + ":",
                    r;
                return e.style.display = "none", dO.appendChild(e), e.src = String(t), r = e.contentWindow.document, r.open(), r.write(Sl("document.F=Object")), r.close(), r.F
            },
            mn, _n = function () {
                try {
        ...
        wl.exports = Object.create || function (t, r) {
            var n;
            return t !== null ? (mo[_o] = cO(t), n = new mo, mo[_o] = null, n[xl] = t) : n = _n(), r === void 0 ? n : lO(n, r)
        }
    });
    var Nl = u((YW, Cl) => {
        var hO = Qi(),
    ...
    var No = u(Sr => {
        ...
        function lf(e, t, r) {
            ...
            function g(_) {
                if (!(0, cA.default)(_)) throw new Error("Actions must be plain objects. Use custom middleware for async actions.");
            ...
            return function (n) {
                return function (i, o, a) {
                    ...
                    return f = t.map(function (d) {
                        return d(p)
                    }), c = TA.default.apply(void 0, f)(s.dispatch), mA({}, s, {
                        dispatch: c
                    })
                }
            }
    ...
    var gS, If, Of = he(() => {
        ...
        De();
        ({
            IX2_RAW_DATA_IMPORTED: gS
        } = be), If = (e = Object.freeze({}), t) => {
            switch (t.type) {
                case gS:
    ...
    var jt = u(me => {
                ...
                if (f != null) {
                    ...
                    if (p.length)
                        for (var d = 0; d <= p.length; d++) {
                            ...
                            if (!(e && n[g] !== void 0)) {
                                var h = f[g];
                                t && Tn(n[g]) && Tn(h) && (h = Fe(e, t, n[g], h)), !(h === void 0 || h === n[g]) && (i || (i = !0, n = bn(n)), n[g] = h)
                            }
                        }
                }
            }
        ...
        function Uf(e, t, r, n, i, o, a) {
            ...
            return p.length ? c = Fe.call.apply(Fe, [null, !1, !1, s, r, n, i, o, a].concat(p)) : c = Fe(!1, !1, s, r, n, i, o, a), An(e, t, c)
        }
    ...
    var ap = u((T5, op) => {
        ...
        function w0(e, t) {
            ...
            if (r instanceof O0) {
                var n = r.__data__;
                if (!A0 || n.length < S0 - 1) return n.push([e, t]), this.size = ++r.size, this;
    ...
    var Jo = u((G5, Fp) => {
        var OR = qp(),
            ...
            wR = Dp ? function (e) {
                return e == null ? [] : (e = Object(e), OR(Dp(e), function (t) {
                    return SR.call(e, t)
                }))
            } : AR;
        Fp.exports = wR
    ...
    var Ln = u((X5, $p) => {
        ...
        function jR(e, t) {
            var r = typeof e;
            return t = t ? ? BR, !!t && (r == "number" || r != "symbol" && kR.test(e)) && e > -1 && e % 1 == 0 && e < t
        }
        $p.exports = jR
    });
    var Pn = u((B5, Qp) => {
    ...
    var ta = u((K5, sv) => {
        ...
        function GC(e, t) {
            var r = LC(e),
                ...
                c = s.length;
            for (var f in e)(t || FC.call(e, f)) && !(a && (f == "length" || i && (f == "offset" || f == "parent") || o && (f == "buffer" || f == "byteLength" || f == "byteOffset") || qC(f, c))) && s.push(f);
            return s
        }
        sv.exports = GC
    });
    ...
    var Vv = u((sB, Uv) => {
        ...
        function PN(e, t, r, n, i, o) {
            ...
            if (g && !p) return o || (o = new ua), a || CN(e) ? SN(e, t, r, n, i, o) : wN(e, t, c, r, n, i, o);
            if (!(r & NN)) {
    ...
    var ag = u((yB, og) => {
        var cL = ig(),
            ...
            dL = cL(function (e) {
                var t = [];
                return e.charCodeAt(0) === 46 && t.push(""), e.replace(lL, function (r, n, i, o) {
    ...
    var Ig = u((SB, bg) => {
        ...
        function VL(e, t, r) {
            ...
            return o || ++n != i ? o : (i = e == null ? 0 : e.length, !!i && GL(i) && FL(a, i) && (DL(e) || ML(e)))
        }
        bg.exports = VL
    });
    var Ag = u((wB, Og) => {
    ...
    var Zg, $e, Bn, kP, ma, It, Qg, kn, jn = he(() => {
        "use strict";
        Zg = ue(ya()), $e = typeof window < "u", Bn = (e, t) => $e ? e() : t, kP = Bn(() => (0, Zg.default)(["matches", "matchesSelector", "mozMatchesSelector", "msMatchesSelector", "oMatchesSelector", "webkitMatchesSelector"], e => e in Element.prototype)), ma = Bn(() => {
            ...
            return "transform"
        }, "transform"), Qg = It.split("transform")[0], kn = Qg ? Qg + "TransformStyle" : "transformStyle"
    });
    var _a = u((BB, ih) => {
        var jP = 4,
            zP = .001,
        ...
        function QP(e, t, r, n, i) {
            var o, a, s = 0;
            do a = t + (r - t) / 2, o = Kn(a, n, i) - e, o > 0 ? r = a : t = a; while (Math.abs(o) > KP && ++s < YP);
            return a
        }
    ...
    var Vr, dt, JP, eq, tq, rq, Ta = he(() => {
        "use strict";
        Vr = ue(_a()), dt = 1.70158, JP = (0, Vr.default)(.25, .1, .25, 1), eq = (0, Vr.default)(.42, 0, 1, 1), tq = (0, Vr.default)(0, 0, .58, 1), rq = (0, Vr.default)(.42, 0, .58, 1)
    });
    var ah = {};
    Me(ah, {
        applyEasing: () => Fq,
    ...
    function uh(e, t, r, n, i) {
        let o = r === Gq ? (0, tr.getIn)(i, ["config", "target", "objectId"]) : null;
        ...
        ({
            ...
            switch (t.type) {
                ...
                case Kq: {
                    ...
                    return (0, tr.getIn)(c, [r, n]) !== n && (c = uh(c, n, a, r, o)), Ia(c, r, s, i, o)
                }
                case Yq: {
                    let {
                        elementId: r,
        ...
        function vh(e) {
            ...
            if (o.startsWith("#")) {
                ...
                let p = (1 - Math.abs(2 * f - 1)) * c,
                    ...
                    g = f - p / 2,
                    h, y, _;
                s >= 0 && s < 60 ? (h = p, y = d, _ = 0) : s >= 60 && s < 120 ? (h = d, y = p, _ = 0) : s >= 120 && s < 180 ? (h = 0, y = p, _ = d) : s >= 180 && s < 240 ? (h = 0, y = d, _ = p) : s >= 240 && s < 300 ? (h = d, y = 0, _ = p) : (h = p, y = 0, _ = d), t = Math.round((h + g) * 255), r = Math.round((y + g) * 255), n = Math.round((_ + g) * 255)
    ...
    var hh = u(Yn => {
        ...
        var Oa = (De(), Je(bf)),
            ...
            QB = Yn.pluginMethodMap = new Map([
                [Oa.ActionTypeConsts.PLUGIN_LOTTIE, {
                    ...OM
                }],
    ...
    var xa, qt, Sa, wa, SM, Ra, wM, Ca, Na, La = he(() => {
        ...
        qt = e => t => {
            ...
            return n
        }, Sa = qt("getPluginConfig"), wa = qt("getPluginOrigin"), SM = qt("getPluginDuration"), Ra = qt("getPluginDestination"), wM = qt("createPluginInstance"), Ca = qt("renderPlugin"), Na = qt("clearPlugin")
    });
    var mh = u((ek, yh) => {
        function RM(e, t) {
    ...
    function Va({
        ...
        if (Array.isArray(o) && o.length > 0) return o.reduce((q, b) => q.concat(Va({
            config: {
                target: b
            },
            event: t,
        ...
        let w = (t ? .action ? .config ? .affectedElements ? ? {})[_ || x] || {},
            V = !!(w.id || w.selector),
            X, k, Y, te = t && s(Wh(t.target));
        if (V ? (X = w.limitAffectedElements, k = te, Y = s(w)) : k = Y = s({
                id: _,
                selector: x,
                selectorGuids: S
            }), t && R) {
    ...
    function P1(e, t = {}, r = {}, n, i) {
        ...
        switch (n.actionTypeId) {
            ...
            case Yh:
                return {
                    value: (0, pt.default)(parseFloat(o(e, Zn)), 1)
                };
            case ar: {
                let s = o(e, ot),
                    c = o(e, at),
                    f, p;
                return n.config.widthUnit === Ot ? f = Xh.test(s) ? parseFloat(s) : parseFloat(r.width) : f = (0, pt.default)(parseFloat(s), parseFloat(r.width)), n.config.heightUnit === Ot ? p = Xh.test(c) ? parseFloat(c) : parseFloat(r.height) : p = (0, pt.default)(parseFloat(c), parseFloat(r.height)), {
                    widthValue: f,
                    heightValue: p
                }
            }
            ...
            case ri:
                return {
                    value: (0, pt.default)(o(e, Jn), r.display)
                };
            case T1:
    ...
    function j1(e, t, r, n) {
        let i = (0, ei.default)(t, (a, s, c) => (a.push(`"${c}" ${s}`), a), []).join(", "),
            {
                setStyle: o
            } = n;
        Mt(e, Br, n), o(e, Br, i)
    ...
    function J1(e, t, r, n, i, o) {
        ...
        switch (n.actionTypeId) {
            case ar: {
                ...
                f !== void 0 && (s === Ot && (s = "px"), Mt(e, ot, o), a(e, ot, f + s)), p !== void 0 && (c === Ot && (c = "px"), Mt(e, at, o), a(e, at, p + c));
                break
            }
            case zr: {
                k1(e, r, n.config, o);
            ...
            case cr: {
                let s = Ua[n.actionTypeId],
                    ...
                    d = r.aValue;
                Mt(e, s, o), a(e, s, d >= 1 ? `rgb(${c},${f},${p})` : `rgba(${c},${f},${p},${d})`);
                break
            }
            default: {
                let {
    ...
    function oD({
        ...
        let {
            actionItemGroups: n,
            continuousParameterGroups: i
        } = e, o = [], a = s => (o.push((0, ti.mergeIn)(s, ["config"], {
            delay: 0,
            duration: 0
        })), s.id === t);
        return n && n.some(({
    ...
    var pt, ei, Qn, ti, a1, s1, u1, c1, l1, f1, d1, p1, v1, g1, Zn, Xr, Br, ot, at, jh, h1, E1, Vh, y1, Hh, m1, Jn, rr, Ot, kr, _1, Da, zh, Fa, Ga, Kh, nr, ir, or, jr, Yh, zr, Kr, ar, sr, ur, cr, ri, T1, $h, Ua, Qh, $n, I1, A1, w1, Xh, N1, L1, q1, M1, D1, Ha, V1, H1, W1, X1, K1, Y1, $1, eE, nE = he(() => {
        ...
        ({
            ...
            GENERAL_DISPLAY: ri,
            OBJECT_VALUE: T1
        } = Ve, $h = e => e.trim(), Ua = Object.freeze({
            [sr]: jh,
            [ur]: h1,
            [cr]: E1
        }), Qh = Object.freeze({
        ...
        A1 = 1;
        w1 = (e, t) => e === t;
        Xh = /px/, N1 = (e, t) => t.reduce((r, n) => (r[n.type] == null && (r[n.type] = V1[n.type]), r), e || {}), L1 = (e, t) => t.reduce((r, n) => (r[n.type] == null && (r[n.type] = H1[n.type] || n.defaultValue || 0), r), e || {});
        q1 = (e, t) => (t && (e[t.type] = t.value || 0), e), M1 = (e, t) => (t && (e[t.type] = t.value || 0), e), D1 = (e, t, r) => {
        ...
        ii = ue(Dt()), vt = ue(jt()), {
            ...
            for (let X = 0, {
                ...
                if (X === 0 && (A = te[0]), S >= Y) {
                    ...
                    let q = i[X + 1],
                        b = q && S !== Y;
                    R = b ? q.actionItems[0] : null, b && (C = Y / 100, w = (q.keyframe - Y) / 100)
                }
            }
            let V = {};
            if (A && !R)
            ...
            d != null && (N = d), x = g ? ? x, a === OD ? N = 0 : (o || y) && (N = x = 0);
            let {
                now: S
            } = t.payload;
            if (r && n) {
                ...
                return p.length && (V = p.reduce((X, k) => {
                    ...
                    return X[k] = b, X
                }, {})), w.current = V, w.position = R, R === 1 && (w.active = !1, w.complete = !0), (0, vt.merge)(e, w)
            }
            return e
            ...
            switch (t.type) {
                ...
                case mD: {
                    let {
                        ...
                        actionTypeId: k
                    } = i, Y = AD(k), te = xD(Y, k), q = Object.keys(g).filter(L => g[L] != null && typeof g[L] != "string"), {
                        easing: b
                    } = i.config;
                    return (0, vt.set)(e, r, {
                        id: r,
    ...
    var cE, lE, LD, PD, dE = he(() => {
        ...
        ({
            ixElements: LD
        } = lE.IX2ElementsReducer), PD = (0, cE.combineReducers)({
            ixData: If,
            ixRequest: Bf,
            ixSession: zf,
            ixElements: LD,
    ...
    var HE = u((Fk, VE) => {
        ...
        function qF(e, t, r, n) {
            ...
            for (var i = -1, o = t.length, a = o - 1, s = e; s != null && ++i < o;) {
                ...
                if (i != a) {
                    var p = s[c];
                    f = n ? n(p, c, s) : void 0, f === void 0 && (f = UE(p) ? p : LF(t[i + 1]) ? [] : {})
                }
                CF(s, c, f), s = s[c]
            }
            return e
    ...
    var YE = u((Hk, KE) => {
        ...
        function QF(e) {
            ...
            var t = zF(e),
                r = [];
            for (var n in e) n == "constructor" && (t || !$F.call(e, n)) || r.push(n);
            return r
        }
        KE.exports = QF
    });
    ...
    var oy = u((jk, iy) => {
        ...
        function S2(e) {
            if (e == null) return !0;
            if (m2(e) && (y2(e) || typeof e == "string" || typeof e.splice == "function" || _2(e) || b2(e) || E2(e))) return !e.length;
            var t = h2(e);
    ...
    var sy = u((zk, ay) => {
        ...
        function N2(e, t) {
            var r = {};
            return t = C2(t, 3), R2(e, function (n, i, o) {
                w2(r, i, t(n, i, o))
            }), r
        }
        ay.exports = N2
    ...
    var yy = u((Zk, Ey) => {
        ...
        function j2(e, t, r) {
            ...
            t = hy(t) || 0, W2(r) && (p = !!r.leading, d = "maxWait" in r, o = d ? B2(hy(r.maxWait) || 0, t) : o, g = "trailing" in r ? !!r.trailing : g);
    ...
    function os({
        ...
        if (e) {
            ...
            if (e.indexOf(Iy) !== -1) {
                let n = e.split(Iy),
                    i = n[0];
                if (r = n[1], i !== document.documentElement.getAttribute(Ay)) return null
            }
    ...
    var pi = u((_j, pm) => {
        ...
        function di(e) {
            this.__wrapped__ = e, this.__actions__ = [], this.__dir__ = 1, this.__filtered__ = !1, this.__iteratees__ = [], this.__takeCount__ = _U, this.__views__ = []
        }
    ...
    var Em = u((bj, hm) => {
        ...
        function AU(e) {
            ...
            return t.__actions__ = OU(e.__actions__), t.__index__ = e.__index__, t.__values__ = e.__values__, t
        }
        hm.exports = AU
    });
    var _m = u((Ij, mm) => {
    ...
    var Hm, Wm, Xm, Bm, ZU, JU, eV, tV, rV, nV, iV, oV, aV, sV, uV, cV, lV, fV, dV, km, jm, pV, vV, gV, zm, hV, EV, Km, yV, ps, Ym, Pm, qm, $m, Qr, mV, st, Qm, _V, Ge, Qe, Zr, Zm, vs, Mm, gs, TV, $r, bV, IV, OV, Jm, Dm, AV, Fm, xV, SV, wV, Gm, gi, hi, Um, Vm, e_, t_ = he(() => {
        ...
        Bm = ue(Dt()), {
            ...
            PAGE_START: Km,
            PAGE_SCROLL: yV
        } = Ye, ps = "COMPONENT_ACTIVE", Ym = "COMPONENT_INACTIVE", {
            COLON_DELIMITER: Pm
        } = we, {
            getNamespacedParameterId: qm
        } = Bm.IX2VanillaUtils, $m = e => t => typeof t == "object" && e(t) ? !0 : t, Qr = $m(({
            element: e,
            nativeEvent: t
        }) => e === t.target), mV = $m(({
            element: e,
            nativeEvent: t
        }) => e.contains(t.target)), st = (0, Hm.default)([Qr, mV]), Qm = (e, t) => {
            if (t) {
                let {
                    ixData: r
                } = e.getState(), {
        ...
        })(), bV = (e, t) => !(e.left > t.right || e.right < t.left || e.top > t.bottom || e.bottom < t.top), IV = ({
            element: e,
            nativeEvent: t
        }) => {
            let {
            ...
            let {
                type: n
            } = t.nativeEvent, i = [ps, Ym].indexOf(n) !== -1 ? n === ps : r.isActive, o = {
                ...r,
                isActive: i
            };
            ...
            let h = (p ? c : o * (c || 0) / 100) / d,
                y, _, N = 0;
            r && (y = g > r.percentTop, _ = r.scrollingDown !== y, N = _ ? g : r.anchorTop);
        ...
        }, xV = (e, t) => e.left > t.left && e.left < t.right && e.top > t.top && e.top < t.bottom, SV = e => (t, r) => {
            let n = {
            ...
            [dV]: {
                ...
                handler: ({
                    ...
                    let {
                        ...
                        pageX: h = o.pageX,
                        pageY: y = o.pageY
                    } = n, _ = s === "X_AXIS", N = n.type === "mouseout", x = p / 100, S = c, A = !1;
                    switch (a) {
                        case nt.VIEWPORT: {
                    ...
                    return N && (x > 1 - Vm || x < Vm) && (x = Math.round(x)), (a !== nt.ELEMENT || A || A !== o.elementHovered) && (x = f ? 1 - x : x, e.dispatch(fr(S, x))), {
                        elementHovered: A,
                        clientX: d,
                        clientY: g,
                        pageX: h,
    ...
    function bi({
        ...
        })), r && (aH(e), tH(), e.getState().ixSession.hasDefinedMediaQueries && YV(e)), e.dispatch($a()), rH(e, n))
    }
    ...
    function rH(e, t) {
        let r = n => {
            ...
            i.active && (e.dispatch(ai(n, o)), t ? $V(e, r) : requestAnimationFrame(r))
        };
    ...
    function dH({
        ...
        (0, vr.default)(s, (d, g) => {
            ...
            XV(N, o.mediaQueryKeys) || t.dispatch(ns()), y.actionTypeId === Ve.GENERAL_CONTINUOUS_ACTION && (Array.isArray(h.config) ? h.config : [h.config]).forEach(A => {
                let {
                    continuousParameterGroupId: R
                } = A, C = (0, gt.default)(a, `${x}.continuousParameterGroups`, []), w = (0, i_.default)(C, ({
                    id: k
                }) => k === R), V = (A.smoothing || 0) / 100, X = (A.restingState || 0) / 100;
                w && d.forEach((k, Y) => {
                    let te = _ + ys + Y;
                    iH({
                        store: t,
        ...
        if (c && c.useFirstGroupAsInitialState) {
            ...
            f.forEach(d => {
                let {
                    config: g,
                    actionTypeId: h
                } = d, y = g ? .target ? .useEventTarget === !0 && g ? .target ? .objectId == null ? {
                    target: s.target,
                    targets: s.targets
                } : g, _ = mi({
                    config: y,
    ...
    function pr({
        ...
        let {
            ixInstances: o,
            ixSession: a
        } = e.getState(), s = a.hasBoundaryNodes && r ? Yr(r, yi) : null;
        (0, vr.default)(o, c => {
            ...
            if (c.actionListId === i && c.eventId === t && p) {
                ...
                bs(c, e), c.verbose && e.dispatch(dr({
                    actionListId: i,
                    isPlaying: !1
                }))
            }
    ...
    function Jr({
        ...
        } = d, h = (0, gt.default)(c, `actionLists.${i}`, {}), {
            actionItemGroups: y,
            useFirstGroupAsInitialState: _
        } = h;
        if (!y || !y.length) return !1;
        o >= y.length && (0, gt.default)(d, "config.loop") && (o = 0), o === 0 && _ && o++;
    ...
    function Ts(e) {
        let {
            ...
            refState: x
        } = h[N] || {}, S = ss(i), A = y.reducedMotion && Xo[o.actionTypeId], R;
        if (A && c) switch (_.events[p] ? .eventTypeId) {
            case Ye.MOUSE_MOVE:
        ...
        if (t.dispatch(Ja({
                ...
                skipToValue: R,
                ...n
            })), h_(document.body, "ix2-animation-started", g), a) {
            vH(t, g);
            return
        }
        Ft({
    ...
    var i_, gt, o_, a_, s_, u_, vr, c_, Ei, RV, Es, ys, yi, l_, CV, r_, mi, NV, ms, Ft, LV, PV, f_, qV, MV, DV, FV, GV, UV, _i, VV, HV, WV, XV, BV, Ti, _s, kV, n_, jV, zV, sH, cH, lH, fH, hs = he(() => {
        "use strict";
        i_ = ue(ya()), gt = ue(Hn()), o_ = ue(NE()), a_ = ue(ny()), s_ = ue(oy()), u_ = ue(sy()), vr = ue(py()), c_ = ue(_y());
        De();
        Ei = ue(Dt());
        ui();
        xy();
        t_();
        RV = Object.keys(Ho), Es = e => RV.includes(e), {
            COLON_DELIMITER: ys,
        ...
        } = Ei.IX2VanillaPlugins, n_ = navigator.userAgent, jV = n_.match(/iPad/i) || n_.match(/iPhone/), zV = 12;
        sH = ["resize", "orientationchange"];
        cH = (e, t) => (0, a_.default)((0, u_.default)(e, t), s_.default), lH = (e, t) => {
            (0, vr.default)(e, (r, n) => {
                r.forEach((i, o) => {
                    let a = n + ys + o;
                    t(i, n, a)
    ...
    var w_ = u((Uj, S_) => {
        ...
        Oi.define("scroll", S_.exports = function (e) {
            ...
            function A(q, b) {
                ...
                switch (b) {
                    case "add":
                        L = q.attr("tabindex"), L ? q.attr("data-wf-tabindex-swap", L) : q.attr("tabindex", "-1");
                        break;
                    case "remove":
                        L = q.attr("data-wf-tabindex-swap"), L ? (q.attr("tabindex", L), q.removeAttr("data-wf-tabindex-swap")) : q.removeAttr("tabindex");
                        break
                }
            ...
            function R(q) {
                ...
                if (!(Oi.env("design") || window.$.mobile && /(?:^|\s)ui-link(?:$|\s)/.test(b.className))) {
                    ...
                    if (L !== "") {
                        var B = e(L);
                        B.length && (q && (q.preventDefault(), q.stopPropagation()), C(L, q), window.setTimeout(function () {
                            w(B, function () {
            ...
            function w(q, b) {
                ...
                if (L !== B) {
                    var U = X(q, L, B),
                        ...
                        ee = function () {
                            var P = Date.now() - J;
                            window.scroll(0, k(L, B, P, U)), P <= U ? s(ee) : typeof b == "function" && b()
                        };
                    s(ee)
                }
            }
            ...
            function te() {
                ...
                o.on(b, d, R), o.on(q, p, function (L) {
                    L.preventDefault()
        ...
        bH.define("touch", R_.exports = function (e) {
            ...
            function n(o) {
                var a = !1,
                    ...
                    f, p;
                o.addEventListener("touchstart", d, !1), o.addEventListener("touchmove", g, !1), o.addEventListener("touchend", h, !1), o.addEventListener("touchcancel", y, !1), o.addEventListener("mousedown", d, !1), o.addEventListener("mousemove", g, !1), o.addEventListener("mouseup", h, !1), o.addEventListener("mouseout", y, !1);

                function d(N) {
                    var x = N.touches;
                    x && x.length > 1 || (a = !0, x ? (s = !0, f = x[0].clientX) : f = N.clientX, p = f)
                }
                ...
                function g(N) {
                    if (a) {
                        ...
                        var x = N.touches,
                            ...
                            A = S - p;
                        p = S, Math.abs(A) > c && r && String(r()) === "" && (i("swipe", N, {
                ...
                function _() {
                    o.removeEventListener("touchstart", d, !1), o.removeEventListener("touchmove", g, !1), o.removeEventListener("touchend", h, !1), o.removeEventListener("touchcancel", y, !1), o.removeEventListener("mousedown", d, !1), o.removeEventListener("mousemove", g, !1), o.removeEventListener("mouseup", h, !1), o.removeEventListener("mouseout", y, !1), o = null
                }
                this.destroy = _
            }
    ...
    var P_ = u((Wj, L_) => {
        ...
        Ai.define("forms", L_.exports = function (e, t) {
            ...
            function S() {
                c = e("html").attr("data-wf-site"), y = "https://webflow.com/api/v1/form/" + c, a && y.indexOf("https://webflow.com") >= 0 && (y = y.replace("https://webflow.com", "https://formdata.webflow.com")), _ = `${y}/signFile`, i = e(s + " form"), i.length && i.each(A)
            }
            ...
            function A(P, W) {
                ...
                D.done.attr("aria-label") || D.form.attr("aria-label", $), D.done.attr("tabindex", "-1"), D.done.attr("role", "region"), D.done.attr("aria-label") || D.done.attr("aria-label", $ + " success"), D.fail.attr("tabindex", "-1"), D.fail.attr("role", "region"), D.fail.attr("aria-label") || D.fail.attr("aria-label", $ + " failure");
                var ie = D.action = j.attr("action");
                if (D.handler = null, D.redirect = j.attr("data-redirect"), N.test(ie)) {
                    D.handler = b;
                    return
                }
                if (!ie) {
            ...
            function C(P) {
                ...
                P.wait = P.btn.attr("data-wait") || null, P.success = !1, W.prop("disabled", !1), P.label && W.val(P.label)
            }
            ...
            function V(P, W) {
                var j = null;
                return W = W || {}, P.find(':input:not([type="submit"]):not([type="file"])').each(function (D, M) {
                    var $ = e(M),
                        ie = $.attr("type"),
                    ...
                    typeof Z == "string" && (Z = e.trim(Z)), W[oe] = Z, j = j || te($, ie, oe, Z)
                }), j
            }
            ...
            function te(P, W, j, D) {
                var M = null;
                return W === "password" ? M = "Passwords cannot be submitted." : P.attr("required") ? D ? f.test(P.attr("type")) && (p.test(D) || (M = "Please enter a valid email address for: " + j)) : M = "Please fill out the required field: " + j : j === "g-recaptcha-response" && !D && (M = "Please confirm you\u2019re not a robot."), M
            }
            ...
            function b(P) {
                ...
                t.each(j, function (Z, de) {
                    f.test(de) && (j.EMAIL = Z), /^((full[ _-]?)?name)$/i.test(de) && (M = Z), /^(first[ _-]?name)$/i.test(de) && (j.FNAME = Z), /^(last[ _-]?name)$/i.test(de) && (j.LNAME = Z)
                }), M && !j.FNAME && (M = M.split(" "), j.FNAME = M[0], j.LNAME = j.LNAME || M[1]);
                var $ = P.action.replace("/post?", "/post-json?") + "&c=?",
                    ie = $.indexOf("u=") + 2;
                ie = $.substring(ie, $.indexOf("&", ie));
                var oe = $.indexOf("id=") + 3;
                oe = $.substring(oe, $.indexOf("&", oe)), j["b_" + ie + "_" + oe] = "", e.ajax({
                    url: $,
                    data: j,
                    dataType: "jsonp"
                }).done(function (Z) {
            ...
            function L(P) {
                ...
                P.done.toggle(D), P.fail.toggle(!D), D ? P.done.focus() : P.fail.focus(), W.toggle(!D), C(P)
            }
            ...
            function U(P, W) {
                ...
                if (g || de.on("click keydown", function (m) {
                    ...
                    }), de.find(".w-icon-file-upload-icon").attr("aria-hidden", "true"), F.find(".w-icon-file-upload-remove").attr("aria-hidden", "true"), g) Z.on("click", function (m) {
                    m.preventDefault()
                    ...
                    F.on("click keydown", function (m) {
                        ...
                        j = m.target && m.target.files && m.target.files[0], j && (M.toggle(!1), oe.toggle(!1), $.toggle(!0), $.focus(), z.text(j.name), I() || w(W), W.fileUploads[P].uploading = !0, J(j, E))
                    });
                ...
                function l(m) {
                    var O = m.responseJSON && m.responseJSON.msg,
                        K = xt;
                    typeof O == "string" && O.indexOf("InvalidFileTypeError") === 0 ? K = ve : typeof O == "string" && O.indexOf("MaxFileSizeError") === 0 && (K = H), ce.text(K), Z.removeAttr("data-value"), Z.val(""), $.toggle(!1), M.toggle(!0), oe.toggle(!0), oe.focus(), W.fileUploads[P].uploading = !1, I() || C(W)
                }
                ...
                function T(m) {
                    if (m) return l(m);
                    $.toggle(!1), ie.css("display", "inline-block"), ie.focus(), W.fileUploads[P].uploading = !1, I() || C(W)
                }
    ...
    var M_ = u((Xj, q_) => {
        ...
        At.define("navbar", q_.exports = function (e, t) {
            ...
            function C() {
                f = d && At.env("design"), p = At.env("editor"), s = e(document.body), c = o.find(h), c.length && (c.each(k), w(), V())
            }
            ...
            function k(v, F) {
                ...
                H || (H = e.data(F, h, {
                    ...
                    config: {},
                    selectedIdx: -1
                })), H.menu = z.find(".w-nav-menu"), H.links = H.menu.find(".w-nav-link"), H.dropdowns = H.menu.find(".w-dropdown"), H.dropdownToggle = H.menu.find(".w-dropdown-toggle"), H.dropdownList = H.menu.find(".w-dropdown-list"), H.button = z.find(".w-nav-button"), H.container = z.find(".w-container"), H.overlayContainerId = "w-nav-overlay-" + v, H.outside = j(H);
                var ve = z.find(".w-nav-brand");
                ve && ve.attr("href") === "/" && ve.attr("aria-label") == null && ve.attr("aria-label", "home"), H.button.attr("style", "-webkit-user-select: text;"), H.button.attr("aria-label") == null && H.button.attr("aria-label", "menu"), H.button.attr("role", "button"), H.button.attr("tabindex", "0"), H.button.attr("aria-controls", H.overlayContainerId), H.button.attr("aria-haspopup", "menu"), H.button.attr("aria-expanded", "false"), H.el.off(h), H.button.off(h), H.menu.off(h), b(H), f ? (te(H), H.el.on("setting" + h, L(H))) : (q(H), H.button.on("click" + h, P(H)), H.menu.on("click" + h, "a", W(H)), H.button.on("keydown" + h, B(H)), H.el.on("keydown" + h, U(H))), M(v, F)
            }
            ...
            function q(v) {
                v.overlay || (v.overlay = e(g).appendTo(v.el), v.overlay.attr("id", v.overlayContainerId), v.parent = v.menu.parent(), ce(v, !0))
            }
            ...
            function b(v) {
                ...
                F.animOver = /^over/.test(H), F.animDirect = /left$/.test(H) ? -1 : 1, z.animation !== H && v.open && t.defer(ee, v), F.easing = v.el.attr("data-easing") || "ease", F.easing2 = v.el.attr("data-easing2") || "ease";
                var ve = v.el.attr("data-duration");
                F.duration = ve != null ? Number(ve) : 400, F.docHeight = v.el.attr("data-doc-height"), v.config = F
            }
            ...
            function L(v) {
                return function (F, z) {
                    z = z || {};
                    var H = i.width();
                    b(v), z.open === !0 && de(v, !0), z.open === !1 && ce(v, !0), v.open && t.defer(function () {
                        H !== i.width() && ee(v)
                    })
                }
            }
            ...
            function B(v) {
                return function (F) {
                    switch (F.keyCode) {
                        ...
                        case Se.HOME:
                        case Se.END:
                            return v.open ? (F.keyCode === Se.END ? v.selectedIdx = v.links.length - 1 : v.selectedIdx = 0, J(v), F.preventDefault(), F.stopPropagation()) : (F.preventDefault(), F.stopPropagation())
                    }
                }
            }
            ...
            function U(v) {
                return function (F) {
                    if (v.open) switch (v.selectedIdx = v.links.index(document.activeElement), F.keyCode) {
                        case Se.HOME:
                        case Se.END:
                            return F.keyCode === Se.END ? v.selectedIdx = v.links.length - 1 : v.selectedIdx = 0, J(v), F.preventDefault(), F.stopPropagation();
                        case Se.ESCAPE:
                            return ce(v), v.button.focus(), F.preventDefault(), F.stopPropagation();
                        case Se.ARROW_LEFT:
                        case Se.ARROW_UP:
                            return v.selectedIdx = Math.max(-1, v.selectedIdx - 1), J(v), F.preventDefault(), F.stopPropagation();
                        case Se.ARROW_RIGHT:
                        case Se.ARROW_DOWN:
                            return v.selectedIdx = Math.min(v.links.length - 1, v.selectedIdx + 1), J(v), F.preventDefault(), F.stopPropagation()
                    }
                }
            }
            ...
            function de(v, F) {
                if (v.open) return;
                v.open = !0, v.menu.each(oe), v.links.addClass(S), v.dropdowns.addClass(_), v.dropdownToggle.addClass(N), v.dropdownList.addClass(x), v.button.addClass(y);
                var z = v.config,
                    H = z.animation;
                ...
                var ve = ut(v),
                    ...
                    l = v.el.height(),
                    E = v.el[0];
                if (M(0, E), A.intro(0, E), At.redraw.up(), f || o.on("click" + h, v.outside), F) {
                    m();
                    return
                }
                var T = "transform " + z.duration + "ms " + z.easing;
                if (v.overlay && (R = v.menu.prev(), v.overlay.show().append(v.menu)), z.animOver) {
                    n(v.menu).add(T).set({
                        x: z.animDirect * ct,
                        height: ve
                    }).start({
                        x: 0
                    }).then(m), v.overlay && v.overlay.width(ct);
                    return
                }
                var I = l + xt;
                n(v.menu).add(T).set({
            ...
            function ut(v) {
                ...
                return F.animOver ? v.menu.height(z) : v.el.css("position") !== "fixed" && (z -= v.el.outerHeight(!0)), v.overlay && v.overlay.height(z), z
            }
            ...
            function ce(v, F) {
                ...
                var z = v.config;
                if ((z.animation === "none" || !n.support.transform || z.duration <= 0) && (F = !0), A.outro(0, v.el[0]), o.off("click" + h, v.outside), F) {
                    n(v.menu).stop(), E();
                    return
                }
                ...
                function E() {
                    v.menu.height(""), n(v.menu).set({
                        x: 0,
                        y: 0
                    }), v.menu.each(Z), v.links.removeClass(S), v.dropdowns.removeClass(_), v.dropdownToggle.removeClass(N), v.dropdownList.removeClass(x), v.overlay && v.overlay.children().length && (R.length ? v.menu.insertAfter(R) : v.menu.prependTo(v.parent), v.overlay.attr("style", "").hide()), v.el.triggerHandler("w-close"), v.button.attr("aria-expanded", "false")
                }
            }
            return r
        })
...
Webflow.require('ix2').init({
    "events": {
        "e-29": {
            ...
            "mediaQueries": ["main"],
            "target": {
                "id": "656a9d9c3a3f6e1cc0746098|b8751aa5-022c-8182-cdae-7717837037bf",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-57": {
            ...
            "target": {
                "selector": ".slide-into-view",
                "originalId": "656a9d9c3a3f6e1cc07460e9|f9e6e84b-b4e2-af8b-9005-98dbb348d63c",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".slide-into-view",
        ...
        "e-74": {
            ...
            "mediaQueries": ["main"],
            "target": {
                "id": "656a9d9c3a3f6e1cc0746098|6d3a9d3c-bae5-f9da-71f5-6f6c3fb501b5",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-85": {
            ...
            "mediaQueries": ["main"],
            "target": {
                "id": "656a9d9c3a3f6e1cc07460e5|1cf7033c-5e94-c156-a9d3-a62ef6b9d65c",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-87": {
            ...
            "mediaQueries": ["main"],
            "target": {
                "id": "656a9d9c3a3f6e1cc07460df|55de7b4c-cfb9-5aab-93ce-3eccf79f6279",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-89": {
            ...
            "target": {
                ...
                "originalId": "6481f4792564fe8b1364f10e|aeae84fc-52d0-4a9d-5ce0-362fde36f07a",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".service-wrapper",
        ...
        "e-91": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "df250e04-0606-c190-0f9f-54a4c0d38eb6",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-93": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "ba5d380e-3b03-429d-bae9-0609ca651c22",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-97": {
            ...
            "mediaQueries": ["main"],
            "target": {
                "id": "656a9d9c3a3f6e1cc07460ec|e9457981-ee6d-9e7b-3f87-676e7e43c819",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-99": {
            ...
            "mediaQueries": ["main"],
            "target": {
                "id": "656a9d9c3a3f6e1cc07460e1|16ed95be-6ae6-595b-56c4-01c57a307f08",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-101": {
            ...
            "mediaQueries": ["main"],
            "target": {
                "id": "656a9d9c3a3f6e1cc0746098|4f92f000-0520-fb3f-bdc2-14cc501ef346",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-103": {
            ...
            "mediaQueries": ["main"],
            "target": {
                "id": "656a9d9c3a3f6e1cc0746098|4f92f000-0520-fb3f-bdc2-14cc501ef355",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-105": {
            ...
            "mediaQueries": ["main"],
            "target": {
                "id": "656a9d9c3a3f6e1cc0746098|4f92f000-0520-fb3f-bdc2-14cc501ef350",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-107": {
            ...
            "mediaQueries": ["main"],
            "target": {
                "id": "656a9d9c3a3f6e1cc0746098|4f92f000-0520-fb3f-bdc2-14cc501ef34b",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-109": {
            ...
            "mediaQueries": ["main"],
            "target": {
                "id": "656a9d9c3a3f6e1cc07460ec|e0a4f054-e62e-28a2-6f5e-4e6f90bdf44b",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-111": {
            ...
            "mediaQueries": ["main"],
            "target": {
                "id": "656a9d9c3a3f6e1cc07460ec|e0a4f054-e62e-28a2-6f5e-4e6f90bdf45a",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-113": {
            ...
            "mediaQueries": ["main"],
            "target": {
                "id": "656a9d9c3a3f6e1cc07460ec|e0a4f054-e62e-28a2-6f5e-4e6f90bdf455",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-115": {
            ...
            "mediaQueries": ["main"],
            "target": {
                "id": "656a9d9c3a3f6e1cc07460ec|e0a4f054-e62e-28a2-6f5e-4e6f90bdf450",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-125": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "656a9d9c3a3f6e1cc07460d2|d7c162f7-bfb0-bedd-8bc3-f6339cd433f7",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-127": {
            ...
            "mediaQueries": ["main"],
            "target": {
                "id": "656a9d9c3a3f6e1cc07460d2|b46d28db-d3d9-afb7-36f6-a6791106c513",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-129": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "fd16b2b1-037d-52ea-548b-48e1fa9052f8",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [],
        ...
        "e-131": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "fd16b2b1-037d-52ea-548b-48e1fa9052e4"
            },
            "targets": [],
            "config": {
                "loop": false,
        ...
        "e-133": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "fd16b2b1-037d-52ea-548b-48e1fa9052e9"
            },
            "targets": [],
            "config": {
                "loop": false,
        ...
        "e-135": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "fd16b2b1-037d-52ea-548b-48e1fa9052ee"
            },
            "targets": [],
            "config": {
                "loop": false,
        ...
        "e-137": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "fd16b2b1-037d-52ea-548b-48e1fa9052f3"
            },
            "targets": [],
            "config": {
                "loop": false,
        ...
        "e-139": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "5f61c35a-5df7-ed2d-7cef-e0f81803b02e",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [],
        ...
        "e-141": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5f61c35a-5df7-ed2d-7cef-e0f81803b01a"
            },
            "targets": [],
            "config": {
                "loop": false,
        ...
        "e-143": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5f61c35a-5df7-ed2d-7cef-e0f81803b01f"
            },
            "targets": [],
            "config": {
                "loop": false,
        ...
        "e-145": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5f61c35a-5df7-ed2d-7cef-e0f81803b024"
            },
            "targets": [],
            "config": {
                "loop": false,
        ...
        "e-147": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5f61c35a-5df7-ed2d-7cef-e0f81803b029"
            },
            "targets": [],
            "config": {
                "loop": false,
        ...
        "e-148": {
            ...
            "createdOn": 1701704651950
        }
    },
    "actionLists": {
        "a-13": {
            "id": "a-13",
            "title": "Move news item to the right",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-13-n-4",
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selector": ".arrow",
                            "selectorGuids": ["e3705ab3-0afe-8579-483c-8ead26d0ea4a"]
                        },
                        "value": 0,
                        "unit": ""
                    }
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".text-small.uppercase",
                            "selectorGuids": ["6163255c-0798-86a0-fdc4-85f51e911372", "3a5f2145-9e95-32ac-3abb-16166808814b"]
                        },
                        "xValue": 20,
                        "xUnit": "px",
                        "yUnit": "PX",
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".text-large",
                            "selectorGuids": ["61d65ca8-deee-e682-9af2-e4dc46579379"]
                        },
                        "xValue": 20,
                        "xUnit": "px",
                        "yUnit": "PX",
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".news-list-headline",
                            "selectorGuids": ["fb1cc3c0-cddb-637f-ce1f-c21e5460811b"]
                        },
                        "xValue": 20,
                        "xUnit": "px",
                        "yUnit": "PX",
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".image-widescreen",
                            "selectorGuids": ["5d991db7-4c66-30af-4c2b-03382da5e34f"]
                        },
                        "xValue": 20,
                        "xUnit": "px",
                        "yUnit": "PX",
            ...
            "createdOn": 1695855601826
        },
        "a-14": {
            "id": "a-14",
            "title": "Move news item to original position",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-14-n-2",
                    "actionTypeId": "TRANSFORM_MOVE",
        ...
        "a-30": {
            "id": "a-30",
            "title": "Mouse move circle button on work",
                    ...
                    "actionItems": [{
                        ...
                        "config": {
                            ...
                            "target": {
                                ...
                                "selectorGuids": ["2bcafe9c-d511-e326-94cb-c478a8fa155b"]
                            },
                            "xValue": 0,
                            "xUnit": "vw",
                            "yUnit": "PX",
            ...
            "createdOn": 1698083735253
        },
        "a-31": {
            "id": "a-31",
            "title": "Increase size of work image on scroll",
            "continuousParameterGroups": [{
                "id": "a-31-p",
            ...
            "createdOn": 1698090461791
        },
        "a-38": {
            "id": "a-38",
            "title": "Open expertise toggle",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-38-n",
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".expertise-content-wrapper",
                            "selectorGuids": ["27c223cf-3b02-d8a3-db11-7a86a2649e0a"]
                        },
                        "heightValue": 0,
                        "widthUnit": "PX",
                        "heightUnit": "px",
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selectorGuids": ["27c223cf-3b02-d8a3-db11-7a86a2649e09"]
                        },
                        "zValue": -90,
                        "xUnit": "DEG",
                        "yUnit": "DEG",
            ...
            "useFirstGroupAsInitialState": true,
            "createdOn": 1679183684498
        },
        "a-39": {
            "id": "a-39",
            "title": "Close expertise toggle",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-39-n",
                    "actionTypeId": "STYLE_OPACITY",
        ...
        "a-40": {
            "id": "a-40",
            "title": "Hover in on animated button",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-40-n",
                    "actionTypeId": "GENERAL_DISPLAY",
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".button-arrow-hover",
                            "selectorGuids": ["07dac033-9925-a409-45e5-04a96cd4603a"]
                        },
                        "value": "block"
                    }
                }, {
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selectorGuids": ["2ae17a02-45c1-cb0e-8920-d350b9cbedea"]
                        },
                        "widthValue": 100,
                        "widthUnit": "%",
                        "heightUnit": "%",
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selectorGuids": ["849944ca-cd36-c7fb-4045-55e6d45becf9"]
                        },
                        "globalSwatchId": "",
                        "rValue": 238,
                        "bValue": 0,
            ...
            "useFirstGroupAsInitialState": false,
            "createdOn": 1698687444564
        },
        "a-41": {
            "id": "a-41",
            "title": "Hover out on animated button",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-41-n",
                    "actionTypeId": "GENERAL_DISPLAY",
        ...
        "a-42": {
            "id": "a-42",
            "title": "Hover in on animated transparent button",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-42-n",
                    "actionTypeId": "GENERAL_DISPLAY",
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".transparent-button-arrow-hover",
                            "selectorGuids": ["3767e5d1-2bd4-7929-d217-28584b517cd7"]
                        },
                        "value": "block"
                    }
                }, {
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".transparent-button-background",
                            "selectorGuids": ["07750753-22fb-51b1-a5bc-b21fc6454dcb"]
                        },
                        "widthValue": 100,
                        "widthUnit": "%",
                        "heightUnit": "%",
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".transparent-button-text",
                            "selectorGuids": ["7a7c0e03-851d-95c3-cd2e-311da68cf6b0"]
                        },
                        "globalSwatchId": "",
                        "rValue": 29,
                        "bValue": 29,
        ...
        "a-43": {
            "id": "a-43",
            "title": "Hover out on animated transparent button",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-43-n",
                    "actionTypeId": "GENERAL_DISPLAY",
        ...
        "a-44": {
            "id": "a-44",
            "title": "Slide in of home hero content",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-44-n",
                    "actionTypeId": "TRANSFORM_MOVE",
                    "config": {
                        ...
                        "duration": 500,
                        "target": {
                            "id": "656a9d9c3a3f6e1cc0746098|9da5572b-1fe5-a483-8bd9-8bb4df4d1650"
                        },
                        "yValue": 8,
                        "xUnit": "PX",
                        "yUnit": "rem",
                    ...
                    "config": {
                        ...
                        "duration": 500,
                        "target": {
                            "id": "656a9d9c3a3f6e1cc0746098|5e5b4ccc-52b3-5865-925a-6bd76548084b"
                        },
                        "yValue": 8,
                        "xUnit": "PX",
                        "yUnit": "rem",
                    ...
                    "config": {
                        ...
                        "duration": 500,
                        "target": {
                            "id": "656a9d9c3a3f6e1cc0746098|237fd272-359c-9856-aed4-993c9a3773e5"
                        },
                        "yValue": 8,
                        "xUnit": "PX",
                        "yUnit": "rem",
            ...
            "useFirstGroupAsInitialState": true,
            "createdOn": 1698956241936
        },
        "a-45": {
            "id": "a-45",
            "title": "Hover in on work item",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-45-n",
                    "actionTypeId": "STYLE_OPACITY",
                    "config": {
                        ...
                        "target": {
                            ...
                            "selectorGuids": ["21306231-a8ea-d368-71a0-7bf149ce7402"]
                        },
                        "value": 0,
                        "unit": ""
                    }
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".work-image",
                            "selectorGuids": ["7d22d6da-c37f-9bc3-3721-f4c4c9f52987"]
                        },
                        "filters": [{
                            "type": "brightness",
                            "filterId": "350a",
            ...
            "useFirstGroupAsInitialState": true,
            "createdOn": 1699043478818
        },
        "a-46": {
            "id": "a-46",
            "title": "Hover out on work item",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-46-n-2",
                    "actionTypeId": "STYLE_OPACITY",
        ...
        "a-7": {
            "id": "a-7",
            "title": "Show arrow on nav link hover in",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-7-n-5",
                    "actionTypeId": "STYLE_OPACITY",
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".nav-arrow",
                            "selectorGuids": ["a0497f8f-b5d6-06b7-9bc8-bb142c862145"]
                        },
                        "value": 0,
                        "unit": ""
                    }
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".nav-link",
                            "selectorGuids": ["6726ee84-dfc8-66e1-4b9c-d4822baa043c"]
                        },
                        "xValue": 20,
                        "xUnit": "px",
                        "yUnit": "PX",
            ...
            "useFirstGroupAsInitialState": true,
            "createdOn": 1695837118050
        },
        "a-8": {
            "id": "a-8",
            "title": "Hide arrow on nav link hover out",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-8-n-2",
                    "actionTypeId": "TRANSFORM_MOVE",
        ...
        "a-47": {
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selectorGuids": ["5b489cd1-67f4-899b-fbc8-5c23a11f19a6"]
                        },
                        "filters": [{
                            "type": "brightness",
                            "filterId": "9b10",
            ...
            "useFirstGroupAsInitialState": false,
            "createdOn": 1701466325511
        },
        "a-48": {
            "id": "a-48",
            "title": "Hover out on team member",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-48-n-2",
                    "actionTypeId": "STYLE_FILTER",
        ...
        "a-9": {
            "id": "a-9",
            "title": "Open menu in transparent navbar",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-9-n",
                    "actionTypeId": "STYLE_OPACITY",
                    "config": {
                        ...
                        "target": {
                            ...
                            "selector": ".nav-menu",
                            "selectorGuids": ["165361b1-c549-dd24-2dc4-4aaa850152ae"]
                        },
                        "value": 0,
                        "unit": ""
                    }
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selectorGuids": ["68ac8337-8165-65d3-dbd7-29c300af7cbe"]
                        },
                        "globalSwatchId": "",
                        "rValue": 0,
                        "bValue": 0,
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".menu-text-yellow",
                            "selectorGuids": ["a2e10903-9108-d036-025f-2e12c429e263"]
                        },
                        "value": "none"
                    }
                }, {
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".close-text",
                            "selectorGuids": ["aba5c137-3159-29ff-2253-85621a2a2708"]
                        },
                        "value": "block"
                    }
                }, {
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".menu-square-yellow",
                            "selectorGuids": ["10012ae8-0376-a491-2ba9-8ce1bba70238"]
                        },
                        "heightValue": 3,
                        "widthUnit": "PX",
                        "heightUnit": "px",
                    ...
                    "config": {
                        ...
                        "duration": 0,
                        "target": {
                            "selector": ".nav-logo-yellow",
                            "selectorGuids": ["244803e2-f56d-910c-9c91-8c82c370afc6"]
                        },
                        "value": "none"
                    }
                }, {
                    ...
                    "config": {
                        ...
                        "duration": 0,
                        "target": {
                            "selector": ".nav-logo-black",
                            "selectorGuids": ["64414be7-a051-a3fd-39c9-59e6eba4482d"]
                        },
                        "value": "block"
                    }
                }]
            ...
            "useFirstGroupAsInitialState": true,
            "createdOn": 1695835065146
        },
        "a-10": {
            "id": "a-10",
            "title": "Close menu in transparent navbar",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-10-n",
                    "actionTypeId": "GENERAL_DISPLAY",
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".menu-text",
                            "selectorGuids": ["297633a3-7737-2f76-09bf-39f5c80ed142"]
                        },
                        "value": "none"
                    }
                }, {
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".menu-square",
                            "selectorGuids": ["1cfb2821-2706-153b-0ba9-db6a24a967d8"]
                        },
                        "heightValue": 3,
                        "widthUnit": "PX",
                        "heightUnit": "px",
